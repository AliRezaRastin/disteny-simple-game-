...
StroyBrain storyBrin = StroyBrain();
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: Visibility(
                  visible: storyBrin.buttonShouldBeVisible(),
                  child: TextButton(
                    onPressed: () {
                      //TODO: Step 19 - Call the nextStory() method from storyBrain and pass the number 2 as the choice made by the user.
                      setState(() {
                        storyBrin.nextStory(2);
                      });
                    },
                    style: TextButton.styleFrom(
